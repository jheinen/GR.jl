...
function _precompile_()
    ...
    @warnpcfail precompile(get_func_ptr, (Ptr{Nothing},LibGR_Ptrs, Symbol) )
    @warnpcfail precompile(get_func_ptr, (Ptr{Nothing},LibGRM_Ptrs, Symbol) )
    @warnpcfail precompile(get_func_ptr, (Ptr{Nothing},LibGR3_Ptrs, Symbol) )
